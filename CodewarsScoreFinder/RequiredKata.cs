...
namespace CodewarsScoreFinder
{
    public class RequiredKata
    {
        ...
        {
            return new RequiredKata(new DataFinder().GetKataList("Kata/RequiredKataList1.csv"));
        }

        public static RequiredKata GetList2()
        {
            return new RequiredKata(new DataFinder().GetKataList("Kata/RequiredKataList2.csv"));
        }

        public static RequiredKata GetList3()
        {
            return new RequiredKata(new DataFinder().GetKataList("Kata/RequiredKataList3.csv"));
        }
    }
}
